          ...
          {PROJECTS.map((project, idx) => {
            ...
            return (
              <AnimatedElement key={project.slug} delay={idx * 0.1 + 0.2}>
                <ProjectCard project={project} isFeatured={isFeatured} getStatusColor={getStatusColor} />
              </AnimatedElement>
            );
          })}
        </div>
...
function ProjectCard({ project, isFeatured, getStatusColor }: any) {
        ...
        <div className="flex gap-2 mt-auto">
          ...
          {project.links?.demo && (
            ...
            >
              ...
              {project.slug === 'commercial-web-platforms' ? 'LIVE' : 'DEMO'}
            </a>
          )}
        </div>
      </div>
